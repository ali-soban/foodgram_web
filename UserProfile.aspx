<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UserProfile.aspx.cs" Inherits="foodgram_web.UserProfile" %>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-8 mx-auto">
                                <center>
                                <div class="form-group">
                                    <asp:Button class="btn btn-block btn-primary btn-lg" ID="Button1" runat="server" Text="Update" />
                                </div>
                                <center>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <center>
                                    <img width="100px" src="imgs/noodles+stick.png" />
                                </center>
                            </div>
                        </div>
